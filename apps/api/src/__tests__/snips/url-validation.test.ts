...
describe("URL validation functions", () => {
  ...
  describe("checkAndUpdateURL", () => {
    ...
    it("should throw error for invalid URLs", () => {
      expect(() => checkAndUpdateURL("http://")).toThrow("Invalid URL");
    });

    it("should throw error for non-http/https protocols", () => {
      expect(() => checkAndUpdateURL("ftp://example.com")).toThrow("Invalid URL");
    });
  });
});
