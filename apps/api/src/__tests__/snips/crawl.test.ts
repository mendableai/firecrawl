...
describe("Crawl tests", () => {
    ...
    describe("robots.txt content type validation", () => {
        const { fetchRobotsTxt } = require("../../lib/robots-txt");
        ...
        it("should return robots.txt content for text/plain content type", async () => {
        ...
        it("should return empty string for text/html content type", async () => {
            jest.spyOn(axios, 'get').mockResolvedValue({
        ...
        it("should return empty string for application/json content type", async () => {
            jest.spyOn(axios, 'get').mockResolvedValue({
