...
> = {
  ...
  [NotificationType.CONCURRENCY_LIMIT_REACHED]: {
    ...
    <p>This is just to let you know that you could be scraping faster by having more browser instances. Consider upgrading your plan at <a href='https://firecrawl.dev/pricing'>firecrawl.dev/pricing</a>.</p>
