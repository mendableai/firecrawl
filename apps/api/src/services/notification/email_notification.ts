...
> = {
  ...
  [NotificationType.CONCURRENCY_LIMIT_REACHED]: {
    ...
    <p>This is just to let you know that you could be scraping faster. Consider upgrading your plan at <a href='https://firecrawl.dev/pricing'>firecrawl.dev/pricing</a>.</p>
