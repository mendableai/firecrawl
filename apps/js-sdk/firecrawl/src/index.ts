...
export interface FirecrawlDocumentMetadata {
  ...
  dctermsCreated?: string | string[];
  dcDateCreated?: string | string[];
  dcDate?: string | string[];
  dctermsType?: string | string[];
  dcType?: string | string[];
  dctermsAudience?: string | string[];
  dctermsSubject?: string | string[];
  dcSubject?: string | string[];
  dcDescription?: string | string[];
  dctermsKeywords?: string | string[];
  modifiedTime?: string;
