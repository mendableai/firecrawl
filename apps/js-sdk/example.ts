import FirecrawlApp, { CrawlStatusResponse, ErrorResponse } from './firecrawl/src/index';

const app = new FirecrawlApp({apiKey: "fc-f1353e1308c34611918bad7023befa1b"});

const main = async () => {

  // Scrape a website:
  const scrapeResult = await app.scrapeUrl('firecrawl.dev', { formats: ['screenshot@fullPage'] });
